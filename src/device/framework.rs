...
impl FrameworkChannel {
    pub fn attach(env: &mut Env, profile: i32, identity: &str) -> jni::errors::Result<Self> {
        ...
        let api_level = env
            ...
            .i()?;
        let with_feature_id = api_level >= 30;
        if with_feature_id {
            env.get_method_id(
                jni_str!("android/app/IActivityManager"),
            ...
            env.get_method_id(
                jni_str!("android/app/IActivityManager"),
                jni_str!("startActivityAsUserWithFeature"),
                jni_sig!((
                    caller: android.app.IApplicationThread,
                    calling_package: java.lang.String,
                    calling_feature_id: java.lang.String,
        ...
        tracing::info!(
            api_level,
            with_feature_id,
            "Android IActivityManager API 계약 확인"
        );
        Ok(Self {
